...
local function main()
   ...
   local checkpoint, optim_state = model11:load(opt)
   print('===> Loaded! Network: ' .. model11.name)
   ...
   if opt.a == 'train' then
      ...
      local trainingExpert = TrainingExpert(model11, optim_state, opt)
   ...
   if opt.a == 'test' then
      ...
      local testingExpert = TestingExpert(dataset, model11, nil, opt)
