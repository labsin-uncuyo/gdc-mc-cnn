...
local function main()
   ...
   local checkpoint, optim_state = model10:load(opt)
   print('===> Loaded! Network: ' .. model10.name)
   ...
   if opt.a == 'train' then
      ...
      local trainingExpert = TrainingExpert(model10, optim_state, opt)
   ...
   if opt.a == 'test' then
      ...
      local testingExpert = TestingExpert(dataset, model10, nil, opt)
