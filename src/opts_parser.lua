...
--   cmd:option('-dataset', 'dataset', 'Path to the dataset folder')
   ...
   cmd:option('-epochs', 15, 'Number of epochs of training')
   ...
   cmd:option('-alternate_proc', false, 'Perform alternate postprocessing')
   cmd:option('-alternate_after_proc', false, 'Perform alternate processing after postprocessing')
   cmd:option('-just_refinement', false, 'Perform refinement process only')
   cmd:option('-full_res_check', true, 'Performs a verification on a full resolution disp map')
