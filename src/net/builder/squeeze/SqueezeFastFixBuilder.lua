...
local SqueezeFastFixBuilder, parent = torch.class('SqueezeFastFixBuilder', 'MCCNNBuilder')

function SqueezeFastFixBuilder:__init()
   parent.__init(self)
...
function SqueezeFastFixBuilder:buildDescriptionNet()
   ...
   descriptionNet:add(cudnn.SpatialConvolution(192, 64, 3, 3))
...
function SqueezeFastFixBuilder:buildDecisionNet()
