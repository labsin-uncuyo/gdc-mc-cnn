...
local SqueezeFast2Builder, parent = torch.class('SqueezeFast2Builder', 'MCCNNBuilder')

function SqueezeFast2Builder:__init()
   parent.__init(self)
...
function SqueezeFast2Builder:buildDescriptionNet()
   ...
   descriptionNet:add(buildFire(64, 16, 64, 64))
...
function SqueezeFast2Builder:buildDecisionNet()
