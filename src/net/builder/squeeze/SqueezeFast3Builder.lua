...
local SqueezeFast3Builder, parent = torch.class('SqueezeFast3Builder', 'MCCNNBuilder')

function SqueezeFast3Builder:__init()
   parent.__init(self)
...
function SqueezeFast3Builder:buildDescriptionNet()
...
function SqueezeFast3Builder:buildDecisionNet()
