...
require 'net/builder/squeeze/SqueezeFast2Builder'

local SqueezeFast2Model, parent = torch.class('SqueezeFast2Model', 'SqueezeFast2Builder')
...
function SqueezeFast2Model:__init(opt)
   parent.__init(self)
