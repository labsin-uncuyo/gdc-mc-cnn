...
require 'net/builder/squeeze/SqueezeFastFixBuilder'

local SqueezeFastFixModel, parent = torch.class('SqueezeFastFixModel', 'SqueezeFastFixBuilder')
...
function SqueezeFastFixModel:__init(opt)
   parent.__init(self)
